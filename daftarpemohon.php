...
<head>
    ...
    <title>e-ReRs | Daftarkan Pemohon </title>
                        ...
                        <div class="card card-purple card-tabs">
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-tabs-two-housemate-tab" data-toggle="pill" href="#custom-tabs-housemate" role="tab" aria-controls="custom-tabs-housemate" aria-selected="true">E-HOUSEMATE <small>SISWA</small></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-two-housematefemale-tab" data-toggle="pill" href="#custom-tabs-housematefemale" role="tab" aria-controls="custom-tabs-housematefemale" aria-selected="true">E-HOUSEMATE <small>SISWI</small></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-two-PBP1-tab" data-toggle="pill" href="#custom-tabs-two-part1" role="tab" aria-controls="custom-tabs-two-messages" aria-selected="false">PELAJAR BAHARU <small> PART 1</small></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-two-siswa-tab" data-toggle="pill" href="#custom-tabs-two-siswa" role="tab" aria-controls="custom-tabs-two-messages" aria-selected="false">SISWA <small></small></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-two-siswi-tab" data-toggle="pill" href="#custom-tabs-two-siswi" role="tab" aria-controls="custom-tabs-two-messages" aria-selected="false">SISWI <small></small></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-housemate" role="tabpanel" aria-labelledby="custom-tabs-housemate-tab">
                                        <!-- /.card-header -->
                                        <div style="overflow-x:auto" class="card-body">
                                            <table id="tableSemakPerm" style="width:100%" class="table table-bordered">
                                                <thead style="background-color:#a29bfe">
                                                    <tr>
                                                        <th class="text-center width10">Matric</th>
                                                        <th class="width25">Nama Penuh</th>
                                                        <th class="text-center width15">Lihat Borang Permohonan</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-housematefemale" role="tabpanel" aria-labelledby="custom-tabs-housematefemale-tab">
                                        <!-- /.card-header -->
                                        <div style="overflow-x:auto" class="card-body">
                                            <table id="tableSemakPermSiswi" style="width:100%" class="table table-bordered">
                                                <thead style="background-color:#a29bfe">
                                                    <tr>
                                                        <th class="text-center width10">Matric</th>
                                                        <th class="width25">Nama Penuh</th>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-two-part1" role="tabpanel" aria-labelledby="custom-tabs-two-PBP1-tab">
                                        <!-- /.card-header -->
                                        <div style="overflow-x:auto" class="card-body">
                                            <table id="tablepbp1" style="width:100%" class="table table-bordered">
                                                <thead style="background-color:#a29bfe">
                                                    <tr>
                                                        <th class="text-center width10">Matric</th>
                                                        <th class="width25">Nama Penuh</th>
                                                        <th class="text-center width5">Program</th>
                                                        <th class="text-center width5">Blok</th>
                                                        <th class="text-center width5">Tingkat</th>
                                                        <th class="text-center width5">Rumah</th>
                                                        <th class="text-center width5">Bilik</th>
                                                        <th class="text-center width15">Action</th>
                                                        <th class="text-center width5">Kunci</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-two-siswa" role="tabpanel" aria-labelledby="custom-tabs-two-siswa-tab">
                                        <!-- /.card-header -->
                                        <div style="overflow-x:auto" class="card-body">
                                            <table id="tablesiswa" style="width:100%" class="table table-bordered">
                                                <thead style="background-color:#a29bfe">
                                                    <tr>
                                                        <th class="text-center width10">Matric</th>
                                                        <th class="width25">Nama Penuh</th>
                                                        <th class="text-center width5">Program</th>
                                                        <th class="text-center width5">Bahagian</th>
                                                        <th class="text-center width15">Action</th>
                                                    </tr>
                                                </thead>
                                            </table>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-two-siswi" role="tabpanel" aria-labelledby="custom-tabs-two-siswi-tab">
                                        <!-- /.card-header -->
                                        <div style="overflow-x:auto" class="card-body">
                                            <table id="tablesiswi" style="width:100%" class="table table-bordered">
                                                <thead style="background-color:#a29bfe">
                                                    <tr>
                                                        <th class="text-center width10">Matric</th>
                                                        <th class="width25">Nama Penuh</th>
    ...
    <script>
        ...
        var dataSemua =
            ...
            foreach (glob("file/upload e-housemate/*.pdf") as $filename) {
                $data[$count] = explode('.', explode('/', $filename)[2])[0];
                $count++;
            }
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (tablePBP1 != null) {
                                tablePBP1.ajax.reload(null, false)
                            }
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (tablesiswi != null) {
                                tablesiswi.ajax.reload(null, false)
                            }
        ...
        $(document).ready(function() {
            $('#custom-tabs-two-housemate-tab').click()
        });
        ...
        $('#custom-tabs-two-housemate-tab').click(function() {
            tablePerm = $('#tableSemakPerm').DataTable({
                "pageLength": 10,
                "ajax": 'senaraiSemuaSiswa.php',
                "destroy": true,
                "columns": [{
                        data: 'userid',
                        render: function(data, type, row) {
                            var result = '';
                            for (var a = 0; a < dataSemua.length; a++) {
                                if (dataSemua[a] == data) {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            dataPerm.append('useridSemak', userid)
                            ...
                            for (var a = 0; a < dataSemua.length; a++) {
                                if (dataSemua[a] == data) {
                                    $.ajax({
                                        ...
                                        success: function(e) {
                                            if (e == 200) {
                                                htmlSemak = '<div class="text-center"><a href="file/upload e-housemate/' + userid + '.pdf" target="_blank">Lihat Borang Permohonan</a></div>';
                                            }
                                        }
                                    })
                                }
        ...
        $('#custom-tabs-two-housematefemale-tab').click(function() {

            tableSemakPermSiswi = $('#tableSemakPermSiswi').DataTable({
                "pageLength": 10,
                "destroy": true,
                "ajax": 'senaraiSemuaSiswi.php',
                "columns": [{
                        data: 'userid',
                        render: function(data, type, row) {
                            var result = '';
        ...
        $('#custom-tabs-two-PBP1-tab').click(function() {
            tablePBP1 = $('#tablepbp1').DataTable({
                "pageLength": 10,
                "destroy": true,
                "ajax": 'dataTableSenaraiPelajarBaru.php',
                "columns": [{
                        data: 'userid',
                        render: function(data, type, row) {
                            result = '<div class="text-center">' + data + '</div>'
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            if (data == "BELUM") {
                                ...
                                result = '<div class="text-center"><i class="fas fa-minus" style="color:black"></i></div>'
                            }
                            return result
                        }
                    }
        ...
        $('#custom-tabs-two-siswa-tab').click(function() {
            tablesiswa = $('#tablesiswa').DataTable({
                "pageLength": 10,
                "destroy": true,
                "ajax": 'dataTableSiswa.php',
                "columns": [{
                        data: 'userid',
                        render: function(data, type, row) {
                            result = '<div class="text-center">' + data + '</div>'
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            result = '<div class="text-center"><button type="button" value="' + row.userid + '" class="updateStudentBtn btn btn-success btn-sm" data-toggle="modal" data-target="#modalUpdateStudent"><i class="fas fa-edit"></i> Daftar</button></div>'
        ...
        $('#custom-tabs-two-siswi-tab').click(function() {
            tablesiswi = $('#tablesiswi').DataTable({
                "pageLength": 10,
                "destroy": true,
                "ajax": 'dataTableSiswi.php',
                "columns": [{
                        data: 'userid',
                        render: function(data, type, row) {
                            result = '<div class="text-center">' + data + '</div>'
