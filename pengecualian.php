...
<body class="hold-transition sidebar-mini">
                        ...
                        <table style="table-layout:fixed; overflow-x:auto; width: 90%; border: 1px solid #ccc; width: 100%">
                            <tr>
                                ...
                                <td id="center">
                                    ...
                                    <center>
                                        <h1 style="font-size:large"><b>PENGECUALIAN BAYARAN KOLEJ</b></h1>
                                        <br>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">PENGECUALIAN BAYARAN KOLEJ</h3>
                                </div>
                                <div class="card-body" style="overflow-x:auto">
                                    <div class="bs-stepper">
                                        <div style="overflow-x:auto" class="bs-stepper-header" role="tablist">
                                            ...
                                            <div class="line"></div>
                                            <div class="step" data-target="#kategori">
                                                <button type="button" style="cursor:default" class="step-trigger" role="tablist" aria-controls="kategori" id="kategori-trigger">
                                                    <span class="bs-stepper-circle"><i class="fa fa-tags"></i></span>
                                                    <span class="bs-stepper-label">Kategori</span>
                                                </button>
                                            </div>
                                            ...
                                            <div class="bs-stepper-content">
                                                <div id="butirpemohon" class="content tab" role="tabpanel" aria-labelledby="butirpemohon-trigger">
                                                    <div class="form-group">
                                                        ...
                                                        <input style="background-color:white" class="form-control" readonly value="<?php echo $username ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Nombor Matriks</label>
                                                        <input style="background-color:white" class="form-control" readonly value="<?php echo $userid ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Kod Program</label>
                                                        <input style="background-color:white" class="form-control" readonly value="<?php echo $userprogramme ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Kad Pengenalan</label>
                                                        <input style="background-color:white" class="form-control" readonly value="<?php echo $useric ?>">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>No Telefon</label>
                                                        <input style="background-color:white" class="form-control" readonly value="<?php echo $userphoneno ?>">
                                                    </div>
                                                ...
                                                <div id="kategori" class="content tab" role="tabpanel" aria-labelledby="kategori-trigger">
                                                    <div class="form-group">
                                                        <label>Kategori <span style="color:red">*</span></label>
                                                        <div class="">
                                                            <select name="usercategory" class="form-control required" oninput="this.className = 'form-control'" id="selectOpt" style="width:100%" onchange="showInput(this)">
                                                                <option value="" hidden selected="selected">-</option>
                                                                <option value="Pelajar Kurang Upaya">Pelajar Kurang Upaya</option>
                                                                <option value="MPP">MPP</option>
                                                                <option value="JPK">JPK</option>
                                                                <option value="Atlit (Wakil Negara / UiTM)">Atlit (Wakil Negara / UiTM)</option>
                                                                <option value="Pasukan Beruniform">Pasukan Beruniform</option>
                                                    ...
                                                    <div id="tunjuklah">
                                                        <label>Nyatakan <span style="color:red">*</span></label>
                                                        <input style='text-transform:uppercase' placeholder="eg. SISPA" class="form-control" name="usercategoryelse">
                                                        <br>
                                                    </div>
                                                ...
                                                <div id="butiranibubapa" class="content tab" role="tabpanel" aria-labelledby="butiranibubapa-trigger">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input placeholder="MASUKKAN ANGKA SAHAJA" type="number" step="0.1" name="fatherincome" class="form-control required" oninput="this.className = 'form-control required'">
                                                        ...
                                                        <input placeholder="MASUKKAN ANGKA SAHAJA" type="number" name="motherincome" class="form-control required" oninput="this.className = 'form-control required'">

                                                        <br>

                                                        <label>Jumlah Pendapatan Keluarga <span style="color:red">*</span></label>
                                                        <input placeholder="MASUKKAN ANGKA SAHAJA" type="number" name="totalincome" class="totIncome form-control required" oninput="this.className = 'form-control required'">
                                                    ...
                                                    <div class="form-group">
                                                        <table class="table-sm">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>AGENSI PINJAMAN/BIASISWA/BANTUAN</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input placeholder="ANGKA SAHAJA" type='number' step='0.1' name='totalscholarship1' class='form-control required' oninput="this.className = 'form-control required'"></td>
                                                            </tr>
    ...
    <script>
        ...
        function addItem() {
            ...
            html += '<td><input type="text" name="familymembersname[]" class="form-control required" style="text-transform: uppercase"</td>';

            html += "<td><input type='text' name='institutename[]'class='form-control required' style='text-transform: uppercase'></td>";

            html += "<td><input type='number' name='yearstudy[]' class='form-control required'></td>";

            html += "<td><input type='text' name='fee[]' class='form-control required' style='text-transform:uppercase'></td>";

            html += "<td><select type='char' name='feestatus[]' class='form-control required'> <option>A</option> <option>B</option> <option>C</option><option>D</option></select></td>";

            html += "<td><input type='number' step='0.1' name='totalscholarship[]' class='form-control required'></td>";
    ...
    if (isset($_POST['submit'])) {
        ...
        $usercategoryelse = $_POST['usercategoryelse'];
        date_default_timezone_set('Asia/Kuala_Lumpur');
        $todayDate = date('Y-m-d');
    ...
    ?>
        ...
        ?>
            ...
            if ($usercategoryelse == null) {
                ...
                if ($fathername != null || $mothername != null) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        $ppk = "INSERT INTO ppk VALUES (null,'$username','$userid','$userprogramme','$useric','$userphoneno',null,null,'$userstatusedu','$usercategory',null,'$houseaddress','$familyphoneno','$fatherusername','$fatherwork','$fatherincome','$newfathername','$motherusername','$motherwork','$motherincome','$newmothername','$totalincome','$totalsiblings','$siblingsnumber','$newDate','PENDING','PENGECUALIAN',null)";
            ...
            ?>
                    ...
                    ?>
                        ...
                        <script>
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "pengecualian.php";
                                } else {
                                    window.location.href = "pengecualian.php";
                                }
                            })
                    ...
                    $ppk = "INSERT INTO ppk VALUES (null,'$username','$userid','$userprogramme','$useric','$userphoneno',null,null,'$userstatusedu','$usercategory',null,'$houseaddress','$familyphoneno','$fatherusername','$fatherwork','$fatherincome',null,'$mothername','$motherwork','$motherincome',null,'$totalincome','$totalsiblings','$siblingsnumber','$newDate','PENDING','PENGECUALIAN',null)";
                    $result = $conn->query($ppk);
                ...
                if ($fathername != null || $mothername != null) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        $ppk = "INSERT INTO ppk VALUES (null,'$username','$userid','$userprogramme','$useric','$userphoneno',null,null,'$userstatusedu','$usercategory','$usercategoryelse','$houseaddress','$familyphoneno','$fatherusername','$fatherwork','$fatherincome','$newfathername','$motherusername','$motherwork','$motherincome','$newmothername','$totalincome','$totalsiblings','$siblingsnumber','$newDate','PENDING','PENGECUALIAN',null)";
                        $result = $conn->query($ppk);
            ...
            if ($usercategoryelse == null) {
                ...
                if ($fathername != null || $mothername != null) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        $ppk = "INSERT INTO ppk VALUES (null,'$username','$userid','$userprogramme','$useric','$userphoneno','$usergpa','$usercgpa','$userstatusedu','$usercategory',null,'$houseaddress','$familyphoneno','$fatherusername','$fatherwork','$fatherincome','$newfathername','$motherusername','$motherwork','$motherincome','$newmothername','$totalincome','$totalsiblings','$siblingsnumber','$newDate','PENDING','PENGECUALIAN',null)";
                        $result = $conn->query($ppk);
                ...
                if ($fathername != null || $mothername != null) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        $ppk = "INSERT INTO ppk VALUES (null,'$username','$userid','$userprogramme','$useric','$userphoneno','$usergpa','$usercgpa','$userstatusedu','$usercategory','$usercategoryelse','$houseaddress','$familyphoneno','$fatherusername','$fatherwork','$fatherincome','$newfathername','$motherusername','$motherwork','$motherincome','$newmothername','$totalincome','$totalsiblings','$siblingsnumber','$newDate','PENDING','PENGECUALIAN',null)";
                        $result = $conn->query($ppk);
