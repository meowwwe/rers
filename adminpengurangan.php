...
<head>
  ...
  <title>e-ReRs | Pengurangan Bayaran Kolej</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>Pengurangan Bayaran Kolej</b></h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Pengurangan Bayaran</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="card card-purple card-tabs">
            <div class="card-header p-0 pt-1">
              <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link active" id="senarai-pendek-tab" data-toggle="pill" href="#senarai-pendek" role="tab" aria-controls="senarai-pendek" aria-selected="true">Pengurangan Bayaran</a>
                </li>
              </ul>
            </div>
            ...
            <div class="card-body" style="overflow-x:auto">
              ...
              <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade show active" id="senarai-pendek" role="tabpanel" aria-labelledby="senarai-pendek-tab">
                  <div style="overflow-x:auto;" class="card-body">
                    <table id="tablependek" style="width:100%" class="table table-bordered table-sm">
  ...
  <script>
    ...
    $(document).ready(function() {
      table = $('#tablepengecualian').DataTable({
        "pageLength": 4,
        "destroy": true,
        "ajax": {
          'url': 'dataTablePengecualian.php',
        },
        "columns": [{
            data: 'userid',
          ...
          },
          {
            data: 'ppkid',
            render: function(data, type, row) {
              result = "<div class='text-center'><button data-toggle='modal' data-target='#modalSemak' value='" + row.ppkid + "' class='semakBtn btn btn-info btn-sm'><i class='fa fa-eye'></i> Semak</button></div>";
              return result;
            }
          },
        ]
    ...
    $(document).ready(function() {
      i = 1
      table = $('#tablependek').DataTable({
        "pageLength": 10,
        "destroy": true,
        "ajax": {
          'url': 'dataTablePengurangan.php',
        },
        "columns": [{
            data: 'count',
            render: function(data, type, row) {
              result = '<div class="text-center">' + i++ + '</div>'
              return result
            }
          },
          {
  ...
  <script>
    function myPrint() {
      window.open("penguranganPrinte.php");
    }
  </script>
