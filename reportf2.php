...
<head>
  ...
  <title>Senarai Nama Siswa</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>Senarai Pendaftaran Kolej Siswi 09A</b></h1>
            </div>
            <div class="col-sm-6">
          ...
          <table style="table-layout:fixed; overflow-x:auto; width: 90%; border: 1px solid #ccc; width: 100%">
            <tr>
              ...
              <td id="center">
                ...
                <center>
                  <h1 style="font-size:large"><b>SENARAI RAKAN SERUMAH KOLEJ TUN TEJA 2</b></h1>
                  <br>
