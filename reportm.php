...
<head>
  ...
  <title>Senarai Rakan Serumah 04A</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>Senarai Pendaftaran Kolej Siswa - 04A</b></h1>
            </div>
            <div class="col-sm-6">
          ...
          <table style="table-layout:fixed; overflow-x:auto; width: 90%; border: 1px solid #ccc; width: 100%">
            <tr>
              ...
              <td id="center">
                ...
                <center>
                  <h1 style="font-size:large"><b>SENARAI RAKAN SERUMAH KOLEJ MAT KILAU</b></h1>
                  <br>
            ...
            <div id="hidebook" class="book hidebook">
              <div id="hidepage" class="page hidepage">
                <div class="card-body" style="overflow-x:auto;">
                  ...
                  <h2><small><b>04A - MAT KILAU</b></small></h2>
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<table id='printe' class='table table-condensed table-bordered table-hover'>
                        <tr>
